...
_TAG_MAP_ID3_1 = {
    ...
    "year": TAG_MAP_ENTRY(
        getter="year", setter="year", type=int, sanitizer=util.sanitize_year
    ),
...
_TAG_MAP_ID3_2_2 = {
    ...
    "tracknumber": TAG_MAP_ENTRY(getter=get_tracknumA, setter=set_tracknumA, type=int),
    "totaltracks": TAG_MAP_ENTRY(
        getter=get_totaltracksA, setter=set_totaltracksA, type=int
    ),
    "discnumber": TAG_MAP_ENTRY(getter=get_discnumA, setter=set_discnumA, type=int),
    "totaldiscs": TAG_MAP_ENTRY(
        getter=get_totaldiscsA, setter=set_totaldiscsA, type=int
    ),
    "genre": TAG_MAP_ENTRY(getter="TCO", setter="TCO", type=str),
    "year": TAG_MAP_ENTRY(
        getter=("TYE", "TDA", "TRD", "TOR"),
    ...
    "artwork": TAG_MAP_ENTRY(getter=get_pictures, setter=set_pictures, type=Artwork),
}
...
_TAG_MAP_ID3_2_3 = {
    ...
    "tracknumber": TAG_MAP_ENTRY(getter=get_tracknumB, setter=set_tracknumB, type=int),
    "totaltracks": TAG_MAP_ENTRY(
        getter=get_totaltracksB, setter=set_totaltracksB, type=int
    ),
    "discnumber": TAG_MAP_ENTRY(getter=get_discnumB, setter=set_discnumB, type=int),
    "totaldiscs": TAG_MAP_ENTRY(
        getter=get_totaldiscsB, setter=set_totaldiscsB, type=int
    ),
    "genre": TAG_MAP_ENTRY(getter="TCON", setter="TCON", type=str),
    "year": TAG_MAP_ENTRY(
        getter=("TYER", "TDAT", "TDRC"),
    ...
    "compilation": TAG_MAP_ENTRY(
        getter="TCMP", setter="TCMP", type=int, sanitizer=util.sanitize_bool
    ),
    "artwork": TAG_MAP_ENTRY(getter=get_pictures, setter=set_pictures, type=Artwork),
}
...
_TAG_MAP_ID3_2_4 = {
    ...
    "tracknumber": TAG_MAP_ENTRY(
        getter=get_tracknumB, setter=set_tracknumB, remover=("TRK", "TRCK"), type=int
    ),
    "totaltracks": TAG_MAP_ENTRY(
        getter=get_totaltracksB,
        setter=set_totaltracksB,
        remover=("TRK", "TRCK"),
        type=int,
    ),
    "discnumber": TAG_MAP_ENTRY(
        getter=get_discnumB, setter=set_discnumB, remover=("TPA", "TPOS"), type=int
    ),
    "totaldiscs": TAG_MAP_ENTRY(
        getter=get_totaldiscsB,
    ...
    "genre": TAG_MAP_ENTRY(getter="TCON", setter="TCON", type=str),
    "year": TAG_MAP_ENTRY(
        getter=("TDOR", "TORY", "TYER", "TDAT", "TDRC"),
    ...
    "artwork": TAG_MAP_ENTRY(
        getter=get_pictures, setter=set_pictures, remover=("APIC", "PIC"), type=Artwork
    ),
}
    ...
    def __init__(self, filename, **kwargs):
        ...
        if id3_ver[0] == 1:
            ...
            raise NotImplementedError(
                "Unexpected id3 tag version: {0}" "".format(mfile.tags.version)
            )
...
class Mp3File(Id3File):
    ...
    def __init__(self, filename, **kwargs):
        ...
        self.tag_map.update(
            {
                "#codec": TAG_MAP_ENTRY(getter=lambda afile, norm_key: "mp3", type=str),
                "#bitspersample": TAG_MAP_ENTRY(
                    getter=lambda afile, norm_key: None, type=int
                ),
            }
        )
