...
class Mp4File(AudioFile):
    ...
    _TAG_MAP = {
        ...
        "tracknumber": TAG_MAP_ENTRY(
            getter=get_tracknum, setter=set_tracknum, type=int
        ),
        "totaltracks": TAG_MAP_ENTRY(
            getter=get_totaltracks, setter=set_totaltracks, type=int
        ),
        "discnumber": TAG_MAP_ENTRY(getter=get_discnum, setter=set_discnum, type=int),
        "totaldiscs": TAG_MAP_ENTRY(
            getter=get_totaldiscs, setter=set_totaldiscs, type=int
        ),
        ...
        "artwork": TAG_MAP_ENTRY(getter=get_artwork, setter=set_artwork, type=Artwork),
    }
    ...
    _TAG_MAP.update(
        {
            ...
            "tracknumber": TAG_MAP_ENTRY(
                getter=util.get_easy_tracknum, setter=util.set_easy_tracknum, type=int
            ),
            "totaltracks": TAG_MAP_ENTRY(
            ...
            "discnumber": TAG_MAP_ENTRY(
                getter=util.get_easy_discnum, setter=util.set_easy_discnum, type=int
            ),
            "totaldiscs": TAG_MAP_ENTRY(
