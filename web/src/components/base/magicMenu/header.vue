  ...
  <div class="monitor-navigation-header">
    <div class="header-title">
      <span
        ...
        @click="handleBack"
        v-if="$route.meta.hasOwnProperty('back')"
      >
        <svg
          class="icon"
          style="
      ...
      >
        ...
        <template slot="content">
          <ul class="monitor-navigation-admin">
            ...
            <li class="nav-item" @click="handleUserListClic3k">使用手册</li>
            <li class="nav-item" @click="handleUserListClick">关于作者</li>
          </ul>
        </template>
      </bk-popover>
    </div>
...
export default {
  ...
  methods: {
    ...
    fetchRecord() {
      this.$api.Task.getRecord({ state: "failed", page_size: 20 }).then(
        (res) => {
          if (res.result) {
