<template>
    <div>
        <div>
            ...
            <div style="margin: 20px;">
                <bk-table :data="data" :size="size" :pagination="pagination" custom-header-color="#e2ebf0"
                    custom-header-color-hover="#cfd9df" @page-change="handlePageChange">
        ...
        <bk-dialog v-model="exampleSetting1.primary.visible" theme="primary" :mask-close="false"
            :header-position="exampleSetting1.primary.headerPosition" :title="exampleSetting1.primary.title">
            <bk-form :label-width="80" :model="formData">
                ...
                <bk-form-item label="角色" :required="true" :property="'role'">
                    <bk-select :disabled="false" v-model="formData.role" ext-cls="select-custom"
                        ext-popover-cls="select-popover-custom" searchable>
                        <bk-option v-for="option in roleList" :key="option.id" :id="option.id" :name="option.name">
                        </bk-option>
                    </bk-select>
                </bk-form-item>
            </bk-form>
